...
[org 0x0100]
    ...
    start:
        ...
        ; If multiplicand is negative then take 2's complement of the Multiplicand
            ...
            adc word [multiplicand + 2], 0
            inc si

    l1:
        cmp byte [multiplier + 3], 0            ; Compare the Most Significant Byte with 0, because it will tell 
													 ; you whether the number is positive or negative
        jge l2

        ; If multiplicand is negative then take 2's complement of the Multiplier

            not word [multiplier]
            not word [multiplier + 2]
            add word [multiplier], 1
            adc word [multiplier + 2], 0
            inc si

    l2:
        mov dx, [multiplier]                    ; LSW (Least Significant Word) of mulitplier
